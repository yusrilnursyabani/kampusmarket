                        ...
                        <div class="flex items-center mb-2">
                            ...
                            <div class="ml-3">
                                ...
                                <div class="text-sm text-gray-500 flex items-center space-x-2">
                                    ...
                                    @if($review->kota_pengunjung || $review->provinsi_pengunjung)
                                        <span class="text-gray-300">•</span>
                                        <span class="flex items-center text-gray-500">
                                            <i class="fas fa-map-marker-alt mr-1"></i>
                                            {{ collect([$review->kota_pengunjung, $review->provinsi_pengunjung])->filter()->implode(', ') }}
                                        </span>
                                    @endif
                                </div>
                            </div>
            ...
            <form method="POST" action="{{ route('products.review.store', $product->slug) }}" class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="provinsi_pengunjung" value="{{ old('provinsi_pengunjung') }}" list="provinsi-options" required
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Kota / Kabupaten *</label>
                        <input type="text" name="kota_pengunjung" value="{{ old('kota_pengunjung') }}" list="kota-options" required
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                </div>

                <datalist id="provinsi-options">
                    @foreach($reviewProvinces as $province)
                        @if(!empty($province))
